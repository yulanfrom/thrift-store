<footer class="bg-dark text-white mt-5 pt-5">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2">
                        <a href="<?php echo e(route('shop')); ?>" class="footer-link">
                            Shop
                        </a>
                    </li>

                    <li class="mb-2">
                        <a href="<?php echo e(route('categories.page')); ?>" class="footer-link">
                            Category
                        </a>
                    </li>
        ...
        <div class="text-center pb-3">
            ...
            © <?php echo e(date('Y')); ?> Fashion Thrift Store |
...
</style><?php /**PATH C:\xampp\htdocs\web\resources\views/partials/footer.blade.php ENDPATH**/ ?>