...
<div class="row align-items-center">
    ...
    <div class="col-lg-6">
        ...
        <a href="<?php echo e(route('shop')); ?>" class="btn btn-dark btn-lg mt-3">
            Shop Now
        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web\resources\views/user/home.blade.php ENDPATH**/ ?>